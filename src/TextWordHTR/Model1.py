...
class Model: 
	...
	def setupCTC(self):
		...
		if self.decoderType == DecoderType.BestPath:
			...
			wordChars = open('../../models/TextWordHTR/wordCharList.txt').read().splitlines()[0]
			corpus = open('../../data/TextWordHTR/corpus.txt').read()
	...
	def dumpNNOutput(self, rnnOutput):
		...
		dumpDir = './../models/TextWordHTR/dump/'
	...
	def save(self):
		"save model to file"
		self.snapID += 1
		self.saver.save(self.sess, '../../models/TextWordHTR/snapshot', global_step=self.snapID)
